...
interface RestApiConfigModalProps {
  onConfigChange: (config: RestApiConfig) => void;
  currentConfig: RestApiConfig;
}

const RestApiConfigModal = ({
  onConfigChange,
  currentConfig,
      ...
      <DialogContent className="max-w-2xl max-h-[80vh] flex flex-col p-0 bg-[#212121] border-gray-700">
        <DialogHeader className="p-6 pb-4 border-b border-gray-700">
          ...
          <DialogDescription className="mt-2 text-gray-300">
            Configure the authentication and context parameters for the REST API
            requests.
          </DialogDescription>
        </DialogHeader>
              ...
              <div className="space-y-2">
                ...
                >
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="nso">Northern Sotho (nso)</SelectItem>
                  </SelectContent>
                </Select>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 gap-6">
              <div className="space-y-2">
                ...
                <ul className="text-xs text-gray-300 list-disc list-inside space-y-1">
                  <li>
                    <strong>Email:</strong> Email clients and anywhere the user
                    would be trying to dictate an email.
                  </li>
                  <li>
                  ...
                  <li>
                    <strong>Other:</strong> Any application that does not fit in
...
export default RestApiConfigModal;
